<template>
  <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <h1 class="my-4 title-tenant">Parceiros</h1>
        ...
        <div class="row my-4">
          ...
          <div class="col-lg-4 col-md-4 col-6 mb-4">
            <div class="restaurant-card">
              <a class="logo" href="vitrine-tenant.html">
                <img class="card-img-top" src="https://static-images.ifood.com.br/image/upload/f_auto,t_thumbnail/logosgde/Logo%20McDonald_MCDON_DRIV15.jpg" alt=""></a>
              <div class="restaurant-card-body">
                <h3>
                  <router-link :to="{name: 'products'}">Mcdonaldis</router-link>
                </h3>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-4 col-6 mb-4">
            <div class="restaurant-card">
              <a class="logo" href="vitrine-tenant.html">
                <img class="card-img-top" src="https://static-images.ifood.com.br/image/upload/f_auto,t_thumbnail/logosgde/201910292243_94aaf166-84cc-4ebf-a35d-d223be34d01f.png" alt=""></a>
              <div class="restaurant-card-body">
                <h3>
